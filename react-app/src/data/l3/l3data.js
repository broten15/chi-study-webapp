...
export const l3trans = [
  ...
  `final exam`,
  `"demand-life; to a life-threatening point," extremely, ... to death 忙得要命：extremely busy, busy to death`,
  `to look for excuses`,
  `an excuse`,
  `truly, really`,
  `at most`,
  `measure word for articles, termpapers`,
  `page 第一 頁 : first page 三页 : three pages`,
  `topic, title`,
  `I'm worried to death`,
  `to blame`,
  `V: to be concerned aboutAdj: concerned N: concern`,
  `"wash-bowl", to wash dishes`,
  `N : 一個 碗 : a bowl M : 一 碗飯 : a bowl of rice`,
  `an hour`,
  `low`,
  `wages`,
  `schoolwork, homework`,
  `"unable to handle the business", too busy, have too much do`,
  `"why on earth?" (colloquial)`,
  `to resemble, to seem, as (similar)`,
  `to be willing to`,
  `to oppose (an opinion, way of doing)`,
  `since, given that`,
  `minimum wage`,
];
export const l3py = [
