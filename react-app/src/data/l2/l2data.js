...
export const l2trans = [
  `V: "come letter", to receive a letter N: (incoming) letter`,
  `to receive (a letter, check, etc.) (NOTE: the object must be concrete)`,
  `(I) did not expect that ...`,
  `remember`,
  `elementary school, primary school`,
  `V: to strongly dislike Adj: annoying, vexing, disgusting`,
  ...
  `Adv: as a result N: result`,
  `not necessarily`,
  `advantage, good or strong points坏处 negative points`,
  `just (a short time before)`,
  `V:to need N: a need`,
  `for a large sum of money, e.g. 大 筆錢`,
  ...
  `to distribute (or to receive as a result of distribution)发薪水 : to distribute or to receive as salary`,
  `salary`,
  ...
  `V: to improve, to make progress Adj: advanced, improved N: improvement, progress 學業 進步 : a common wish for students`,
];
export const l2py = [
`láixìn`,
`shōudào`,
