...
export const l4trans = [
  ...
  `V: "face-talk", to have an interview N: interview`,
  `to see or to meet someone (for a special or offical purpose)`,
  `long-distance`,
  `office`,
  ...
  `East Asian Studies`,
  `East Asia`,
  `V: to research N: research, studies`,
  `summer`,
  `winter`,
  `spring`,
  `fall`,
  `number of times (going, etc.)`,
  `besides, in addition...`,
  `V: to study, to emulate N: study, studies`,
  ...
  `V: to help N: help`,
  `at first`,
  `(here) to guide, to lead (a tour) dài day`,
  `educational background (formal usage)`,
  ...
  `daily`,
  `conversation`,
  `handle, to deal with, to cope with`,
  `to fill in (a form)`,
  `a form`,
  `(here) to hand in, to submit`,
  `secretary`,
  `within (a certain range of time, space, etc.)`,
  `V: to inform, to notify N: notification; a notice`,
  `full name (formal)`,
  ...
  `U.S. dollars`,
  `dollar (formal)`,
  `"prepare for (further) note/comment" comments (on form)`,
];
export const l4py = [
`shēnqǐng`,
`xiānshēng`,
